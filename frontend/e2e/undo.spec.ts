...
// (The old "ctrl+z is scoped per view" e2e was removed with the Execute
// tab in v08 -- there's no longer a second view with its own undoable
// actions to demonstrate the scoping against. The mechanism stays covered
// by src/undo/UndoProvider.test.tsx's per-view-scoping unit tests.)
