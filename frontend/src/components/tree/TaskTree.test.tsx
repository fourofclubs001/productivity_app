...
describe('TaskTree', () => {
  it('shows an empty state when there are no tasks', () => {
    renderWithClient(<TaskTree tasks={[]} selectedId={null} onSelect={() => {}} />)
  ...
  it('renders root tasks collapsed, expanding on chevron click', () => {
    ...
    renderWithClient(<TaskTree tasks={[parent, child]} selectedId={null} onSelect={() => {}} />)
  ...
  it('renders a shared child under each of its parents (DAG, not a tree)', () => {
    ...
    renderWithClient(
      <TaskTree tasks={[parentA, parentB, child]} selectedId={null} onSelect={() => {}} />,
    )
  ...
  it('calls onSelect with the task id when a row is clicked', () => {
    ...
    renderWithClient(<TaskTree tasks={[task]} selectedId={null} onSelect={onSelect} />)
